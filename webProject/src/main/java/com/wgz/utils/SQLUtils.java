...
public class SQLUtils {
	   ...
	   * 是否替换orderBy
	   * @param strSQL
	   * @param isReplaceOrderBy
	   * @return
	   */
	  public static String buildCountSQL(Object strSQL, boolean isReplaceOrderBy) {
	...
	public static String buildCountSQL(Object strSQL, boolean isReplaceOrderBy, String indexField) {
		StringBuffer countBuff = new StringBuffer();
	    if (strSQL != null) {
	      String sql = null;
	      if (strSQL instanceof String) {
	      ...
	      if (containsDistinctKeywords(sql)) {
	        ...
	        if(isReplaceOrderBy){
	    	  ...
	    	  //countBuff.append(sql).append(" ) c_1");
	    	  countBuff.append(" select count( ");
	    	  countBuff.append(indexField);
	    	  countBuff.append(" ) from ( ");
	    	  countBuff.append(sql).append(" ) c_1");
	      }else {
	        //countBuff.append("select count(*) ");
	    	  countBuff.append(" select count( ");
